...
| **Guition JC3248W535** | ESP32-S3-N16R8 | base `28:84:85:49:4D:20` (SSID `Setup-4D21`) | `303A:1001` (native USB) | AXS15231B **320×480** QSPI + AXS15231B I2C touch | LVGL head-unit — `esp32-guition-live-ota`. 8 MB OPI PSRAM, 16 MB flash. QSPI panel driven via Arduino_GFX (pinned 1.6.0); LVGL full-refresh mode. See [guition-board.md](code/findings/guition-board.md). |
