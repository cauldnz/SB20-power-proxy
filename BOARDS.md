...
| **C3 + 0.96" OLED** (AliExpress) | ESP32-C3 | base/STA `10:B4:1D:BA:C9:0C` | `303A:1001` (native USB-JTAG) | SSD1306 **128×64** @0x3C, SDA=5/SCL=6 | New head-unit C3. 4 MB XMC flash. Needs the `esp32c3-oled96` variant (U3). Onboarded via the I2C probe (maker-skills#160). |
