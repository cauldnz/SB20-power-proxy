...
// SB20 vendoring note: trimmed to the DISPLAY panel driver only. The upstream file also carried the
// AXS15231B I2C touch driver (esp_lcd_touch_new_i2c_axs15231b + statics) and included esp_lcd_touch.h;
// arduino-esp32 doesn't bundle the esp_lcd_touch component, so that code was removed. Touch for this
// board is hand-rolled over Wire in firmware/src/disp/GuitionDisplay.h. Unmodified otherwise.
#include <stdlib.h>
#include <sys/cdefs.h>
