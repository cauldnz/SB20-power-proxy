...
// NOTE (SB20 vendoring): the AXS15231B I2C *touch* driver from the upstream component
// (esp_lcd_touch_new_i2c_axs15231b + its config macros) was removed here — it needs the
// separate esp_lcd_touch component, which arduino-esp32 doesn't bundle. This board's touch is
// hand-rolled over Wire in firmware/src/disp/GuitionDisplay.h. Display panel driver only.
