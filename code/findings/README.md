...
- **[guition-board.md](guition-board.md)** — the **Guition JC3248W535** (ESP32-S3-N16R8, 3.5" **320×480 AXS15231B QSPI** + capacitive touch, 8 MB PSRAM, COM14): ported head-unit target (`esp32-guition*` envs) driven via **Arduino_GFX** (QSPI, pinned 1.6.0) with LVGL **full-refresh** mode + the port gotchas (GPIO8 = touch SCL not the LED!). The first QSPI-panel board.
