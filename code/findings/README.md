...
- **[track-launch-control-spec.md](track-launch-control-spec.md)** — *(draft specification)* **V1 build contract** for launch-control hardware, workflow, timing, capture, deep modules, state models, storage, UI, security, analysis confidence and acceptance.
- **[track-launch-control-plan.md](track-launch-control-plan.md)** — *(draft plan)* **Evidence-gated delivery sequence** from generated contract and pure modules through Waveshare/nRF bring-up, durable BLE transfer, coach UI, static-bike proof and velodrome validation.
